...
struct FlagStatus {
    z_mod:  FlagMod, // Flag modifiers: for each flag, define if this instruction ignores this
    n_mod:  FlagMod, // flag, sets this flag to a fixed value, or sets it to a value that is
    hc_mod: FlagMod, // evaluated within this instruction.
    cy_mod: FlagMod
}
